...
#define PROGRAM_NAME		"RavenMiner"
...
// get const array size (defined in RavenMiner.cpp)
int options_count()
{
	int n = 0;
...
#define YES "Share Accepted! Kaaaaawwww!"
#define YAY "Block Solved!! Kaaaakaaaaawwww!!!"
#define BOO "Well Shit -_- Share Rejected!!"
...
int main(int argc, char *argv[])
{
	...
	printf("*** RavenMiner " PACKAGE_VERSION " for nVidia GPUs by tpruvot@github ***\n");
	printf("***       Modified by todd1251(penfold) & MSFTserver       ***\n");
	if (!opt_quiet) {
		...
		printf("                   hhhhhhhhhhh              \n");
		printf("                  hhhhhhhooooohh            \n");
		printf("                 hhhhhh++oo++ohhhh          \n");
		printf("	         hhhhhhhhoooohhoooohhhhhh     |------------- \n");
		printf("	        hhhhhhhhhhhhhooooohhhhhhhhh  <  Kawwwwwww! | \n");
		printf("	        hhhhhhhhhhhhoooooohhhh        |------------- \n");
		printf("	       hhhhhhhhhhhooooooo             \n");
		printf("	      hhhhhoooooooooooooohh           \n"); 
		printf("	     hhhhooooooooooooooohhhh          \n");
		printf("	     hhhhooooooooooooooohhhh          \n");
		printf("	    hhhhhhoooooooooooooohhhhh         \n");
		printf("	    hhhhhhhoooooooooooohhhhh          \n");
		printf("	   hhhhhhhhhooooooooooohhhhh          \n");
		printf("	   hhhhhhhhhhoooooooooohhhh           \n");
		printf("	  hhhhhhhhhhhhoooooooohhhhh           \n");
		printf("	  hhhhhhhhhhhhhooooooohhhh            \n");
		printf("	 hhhhhhhhhhhhhhhoooooohhhh            \n");
		printf("	 hhhhhhhhhhhhhhhhooooohhh             \n");
		printf("	hhhhhhhhhhhhhhhhhhooohhhh             \n");
	}
